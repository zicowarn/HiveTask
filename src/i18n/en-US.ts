...
export const enUS: Record<MessageKey, string> = {
  ...
  "repo.remoteLater": "Remote-only registration arrives with phase B",
  ...
  "settings.giteaHost": "Gitea URL",
  "settings.giteaHostDesc": "Address of your self-hosted Gitea instance",
  "settings.giteaToken": "Gitea access token",
  "settings.giteaTokenSet": "Configured (stored in the OS keychain)",
  "settings.giteaTokenUnset": "Not configured",
  "settings.giteaTokenPlaceholder": "Paste an access token (write-only)",
  "settings.giteaTokenClear": "Clear",
  "settings.giteaTokenSaved": "Token stored in the OS keychain",
  "settings.giteaTokenCleared": "Token cleared",
  "settings.save": "Save",

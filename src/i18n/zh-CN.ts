...
export const zhCN = {
  ...
  "repo.remoteLater": "仅远端登记将随阶段 B 提供",
  ...
  "settings.giteaHost": "Gitea 地址",
  "settings.giteaHostDesc": "自建 Gitea 实例的地址，如 https://gitea.example.com",
  "settings.giteaToken": "Gitea 访问令牌",
  "settings.giteaTokenSet": "已配置（存于系统钥匙串）",
  "settings.giteaTokenUnset": "未配置",
  "settings.giteaTokenPlaceholder": "粘贴访问令牌（只写不回显）",
  "settings.giteaTokenClear": "清除",
  "settings.giteaTokenSaved": "令牌已存入系统钥匙串",
  "settings.giteaTokenCleared": "令牌已清除",
  "settings.save": "保存",

...
const ROUTING_ONLY: Record<string, string[]> = {
  ...
  "03-数据/3D/三角面.fbx": ["model3d"],
  "03-数据/3D/模型.dae": ["model3d"],
  "03-数据/3D/模型.3ds": ["model3d"],
  "03-数据/3D/模型.3mf": ["model3d"],
  "03-数据/3D/模型.amf": ["model3d"],
  "03-数据/3D/模型.usda": ["model3d"],
  "03-数据/3D/模型.usdz": ["model3d"],
  "03-数据/3D/立方体.wrl": ["model3d"],
